...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-02-08 13:33`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/80f557f9-fc12-4f9f-af8b-aefb36e23cce.git
$ cd 80f557f9-fc12-4f9f-af8b-aefb36e23cce
```
